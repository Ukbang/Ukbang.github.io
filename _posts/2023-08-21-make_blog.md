...
![fork image](../image/23-08-21_make_blog/fork.png)
...
![config image](../image/23-08-21_make_blog/config.png)  
...
![blog image](../image/23-08-21_make_blog/blog.png)
...
![Create_new_file](../image/23-08-21_make_blog/create_new_file.png)
![Create_new_file2](../image/23-08-21_make_blog/create_new_file_2.png)

글의 이름은 **연-월-일-제목.md** 로 작성합니다. # slug를 설정하지 않으면 제목이 url이 됩니다.
[example](../image/23-08-21_make_blog/example_img.png)
[example2](../image/23-08-21_make_blog/example_img2.png)
